...
var showButton = document.querySelector(".team__show");
var itemNone = document.querySelectorAll(".team__item--none");
showButton.addEventListener("click", function (e) {
  var _iterator = _createForOfIteratorHelper(itemNone),
      _step;
